...
./__deploy_sales_portal.sh $1 $2 $3 > /home/user/projects/Workspace_2/sales_portal_admin/zzdeploy_log/_admin_${ZZ_CURR_SPACE:16}_`date -d "+9 hours" +%y%m%d%H%M%S`.log
