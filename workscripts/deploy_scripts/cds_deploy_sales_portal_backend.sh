...
ZZ_LOG_FILE_NAME=$(create_logfile_name "backend_cds")
find /home/user/projects/Workspace_2/zzdeploy_logs/${1^^} -name "_${ZZ_LOG_SPACE}_backend_cds_*.log" $ZZ_MTIME_OR_MMIN -delete
./__cds_deploy_sales_portal_backend.sh $1 $2 $3 > /home/user/projects/Workspace_2/zzdeploy_logs/${1^^}/$ZZ_LOG_FILE_NAME
echo -e "\n${BLUE_}$ZZ_LOG_FILE_NAME is completed....${NOCOLOR}\n"
