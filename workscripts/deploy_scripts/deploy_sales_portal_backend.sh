...
# find /home/user/projects/Workspace_2/sales_portal_backend/zzdeploy_log -name "_backend_${ZZ_CURR_SPACE:16}_*.log" -mtime +2 -delete
# ./__deploy_sales_portal_backend.sh $1 $2 $3 > /home/user/projects/Workspace_2/sales_portal_backend/zzdeploy_log/_backend_${ZZ_CURR_SPACE:16}_`date -d "+9 hours" +%y%m%d%H%M%S`.log
