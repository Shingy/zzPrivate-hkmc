...
./__deploy_sales_portal_backend.sh $1 $2 > /home/user/projects/Workspace_2/sales_portal_backend/zzdeploy_log/_backend_${ZZ_CURR_SPACE:16}_`date -d "+9 hours" +%y%m%d%H%M%S`.log
